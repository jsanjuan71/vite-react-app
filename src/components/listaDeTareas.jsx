...
function ListaDeTareas() {
    ...
    function clickAgregar() {
        ...
        if (symbols.somes((symbol) => textoTarea.includes(symbol))) {
            setE;
            rrorMessage('No se permiten caracteres especiales');
                            ...
                            >
                                <div style={{ alignItems: 'left' }}>
                                    <input
                                        ...
                                        onChange={(event) =>
                                            checkBoxPresionado(tarea, event.target.checked)
                                        }
                                    />
                                    &nbsp;
                                    {tarea.todo}
                                ...
                                <button>
                                    <Link to={'/lista/' + tarea.id}>Ver detalle</Link>
                                </button>
                            </div>
                        </li>
                    );
