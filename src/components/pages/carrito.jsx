...
function Carrito() {
    ...
    }, [storageCarrito.almacenamiento] ) // ejecutar cada vez que cambie el carrito
                ...
                carrito.productos?.map((itemCarrito, indice) => {
                    return(
                        <Row key={indice} className="d-flex mb-3">
                            ...
                            <Col md={2}><img src={itemCarrito.producto.thumbnail} width={"100%"} /></Col>
                            <Col md={4}>{itemCarrito.producto.title}</Col>
                            <Col md={2}>{itemCarrito.cantidad}</Col>
                            <Col md={2}>${itemCarrito.producto.price}</Col>
                            <Col md={2}>${ Number(itemCarrito.producto.price) * itemCarrito.cantidad}</Col>
                        </Row>
                    )
                })
            }
